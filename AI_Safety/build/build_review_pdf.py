"""Build AI_Safety/Frontier_Review.pdf from FRONTIER_REVIEW.md (a copy of Maps_and_Territories/build/build_pdf.py with the paths and title changed) (a small Markdown subset) with fpdf2.
...
MD = DOC_DIR / "FRONTIER_REVIEW.md"
OUT = DOC_DIR / "Frontier_Review.pdf"
...
class Doc(FPDF):
    def __init__(self):
        ...
        self.set_title("Frontier AI safety in 2026 and where CRR might help"); self.set_author("CRR re-validation repository")

    def footer(self):
        self.set_y(-12); self.set_font("DV", "", 7.5); self.set_text_color(*INK2)
        self.cell(0, 6, f"Frontier AI safety review — CRR re-validation repository, 2026-09-24 — page {self.page_no()}", align="C")
