"""Build Adam_SGD/Adam_SGD.pdf from ADAM_SGD.md (a copy of Continuous_Learning/build/build_pdf.py with the paths and title changed) (a small Markdown subset) with fpdf2.
...
DOC_DIR = ROOT / "Adam_SGD"
MD = DOC_DIR / "ADAM_SGD.md"
OUT = DOC_DIR / "Adam_SGD.pdf"
...
class Doc(FPDF):
    def __init__(self):
        ...
        self.set_title("The equanimity rule under SGD and Adam"); self.set_author("CRR re-validation repository")

    def footer(self):
        self.set_y(-12); self.set_font("DV", "", 7.5); self.set_text_color(*INK2)
        self.cell(0, 6, f"The equanimity rule under SGD and Adam — CRR re-validation repository, 2026-09-23 — page {self.page_no()}", align="C")
