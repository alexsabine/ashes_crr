...
- Repository documents: `theory/CRR.md` (H-EQ, P4); `docs/notes/2026-09-22_omega_sweeps.md`; `reports/eqx.md`, `reports/eq2.md`, `reports/eq3.md`; `prereg/eq2/PREREG.md`, `prereg/eq2r/PREREG.md`, `prereg/eq3/PREREG.md`; `ledger/LEDGER.md`; `notebook/AGENT_LOG.md` entries 25, 40, 58, 59, 60.
