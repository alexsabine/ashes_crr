...
| `ADAM_AND_PRIOR_ART.md`, `Adam_and_Prior_Art.pdf` | 2026-09-23 (prompt-log entry 104): the rule under Adam, SGD and momentum, beside its prior art (the VQGAN adaptive weight, PINN loss balancing, GradNorm, FedKACE, AutoClip, AdamW), and against a finely tuned constant; checks `checks/adam_checks{,_2,_3}.py` with pinned outputs, each declared before it ran (`DECLARATION_ADAM{,_2,_3}.md`); literature in `docs/citations/continual_learning_2026-09-23.md`; the real-data study of the same day is `reports/eq4.md` |
