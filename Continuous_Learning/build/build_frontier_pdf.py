"""Build Continuous_Learning/Frontier_Bottlenecks.pdf from FRONTIER_BOTTLENECKS.md (a copy of Continuous_Learning/build/build_pdf.py with the paths and title changed) (a small Markdown subset) with fpdf2.
...
MD = DOC_DIR / "FRONTIER_BOTTLENECKS.md"
OUT = DOC_DIR / "Frontier_Bottlenecks.pdf"
MATH_DIR = DOC_DIR / "build" / "math_frontier"
...
class Doc(FPDF):
    def __init__(self):
        ...
        self.set_title("Where the frontier of continual learning is, and where CRR might apply"); self.set_author("CRR re-validation repository")

    def footer(self):
        self.set_y(-12); self.set_font("DV", "", 7.5); self.set_text_color(*INK2)
        self.cell(0, 6, f"Frontier continual-learning bottlenecks — CRR re-validation repository, 2026-09-23 — page {self.page_no()}", align="C")
