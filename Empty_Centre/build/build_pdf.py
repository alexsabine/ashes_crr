"""Build Empty_Centre/The_Empty_Centre.pdf from THE_EMPTY_CENTRE.md (a copy of Maps_and_Territories/build/build_pdf.py with the paths and title changed) (a small Markdown subset) with fpdf2.
...
DOC_DIR = ROOT / "Empty_Centre"
MD = DOC_DIR / "THE_EMPTY_CENTRE.md"
OUT = DOC_DIR / "The_Empty_Centre.pdf"
...
class Doc(FPDF):
    def __init__(self):
        ...
        self.set_title("Holding an Empty Centre: continual learning and AI safety as one design"); self.set_author("CRR re-validation repository")

    def footer(self):
        self.set_y(-12); self.set_font("DV", "", 7.5); self.set_text_color(*INK2)
        self.cell(0, 6, f"Holding an Empty Centre — CRR re-validation repository, 2026-09-24 — page {self.page_no()}", align="C")
