"""Build Epistemic_Review/Epistemic_Review.pdf from EPISTEMIC_REVIEW.md (a copy of AI_Safety/build/build_pdf.py with the paths and title changed) (a small Markdown subset) with fpdf2.
...
from matplotlib's bundled set. Run: uv run python Epistemic_Review/build/build_pdf.py
"""
...
DOC_DIR = ROOT / "Epistemic_Review"
MD = DOC_DIR / "EPISTEMIC_REVIEW.md"
OUT = DOC_DIR / "Epistemic_Review.pdf"
...
class Doc(FPDF):
    def __init__(self):
        ...
        self.set_title("What a Pass Means Here: an epistemic review of the CRR pipeline"); self.set_author("CRR re-validation repository")

    def footer(self):
        self.set_y(-12); self.set_font("DV", "", 7.5); self.set_text_color(*INK2)
        self.cell(0, 6, f"What a Pass Means Here — CRR re-validation repository, 2026-09-23 — page {self.page_no()}", align="C")
