"""Build Rupture_Detection/Rupture_Detection.pdf from RUPTURE_DETECTION.md (a copy of Continuous_Learning/build/build_pdf.py with the paths and title changed) (a small Markdown subset) with fpdf2.
...
DOC_DIR = ROOT / "Rupture_Detection"
MD = DOC_DIR / "RUPTURE_DETECTION.md"
OUT = DOC_DIR / "Rupture_Detection.pdf"
...
class Doc(FPDF):
    def __init__(self):
        ...
        self.set_title("The cut as a rupture detector: a Phase-A battery and the applied use case"); self.set_author("CRR re-validation repository")

    def footer(self):
        self.set_y(-12); self.set_font("DV", "", 7.5); self.set_text_color(*INK2)
        self.cell(0, 6, f"The cut as a rupture detector — CRR re-validation repository, 2026-09-23 — page {self.page_no()}", align="C")
